...
public enum MessagesUtil {
	...
	HELP_TITLE("&c&lTrailPaths &r&7- Help Menu"),
	HELP_COMMAND("&c%command% &7- %description%"),
	TOGGLE_PATH_ON("&eYou have toggled your trail paths: &aON"),
	TOGGLE_PATH_OFF("&eYou have toggled your trail paths: &cOFF"),
